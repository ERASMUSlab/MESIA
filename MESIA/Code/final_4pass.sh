...
cat $name/final/$sample_set1"_base.narrowPeak" $name/final/$sample_set2"_base.narrowPeak"  $name/final/$sample_set3"_base.narrowPeak" $name/final/$sample_set4"_base.narrowPeak" \
